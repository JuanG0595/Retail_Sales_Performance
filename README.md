...
This project, called "Retail Sales Performance," was created using data obtained from the website www.kaggle.com, specifically from the repository "Retail Store Sales: Dirty for Data Cleaning." This project aims to simulate a controlled data analysis environment in which I seek to establish certain parameters, processes, and other elements that will demonstrate proficiency in the use of relevant tools and knowledge in this field.
